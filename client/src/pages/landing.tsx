      ...
      <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', sans-serif" }} data-testid="front-page">
        ...
        <section id="features" className="py-[50px] sm:py-[80px] px-5 sm:px-6 bg-white scroll-mt-16" data-testid="front-operating-system">
          <div className="max-w-[900px] mx-auto text-center">
            ...
            <p className="text-[14px] sm:text-[16px] text-[#888] max-w-[320px] sm:max-w-[620px] mx-auto leading-[1.7] sm:leading-[1.6]">Brings your credit, capital, and funding into one unified system — so you can see exactly how banks evaluate you before you apply. Understand what's working, what's holding you back, and how much you can realistically access. Profundr breaks down your profile, shows you where you stand, and gives you a clear path to approval. Fix what matters. Move with precision. Get funded.</p>
          </div>
        </section>
