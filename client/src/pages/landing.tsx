      ...
      <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', sans-serif" }} data-testid="front-page">
        ...
        <section className="py-[50px] sm:py-[80px] px-5 sm:px-6 bg-white border-t border-[#f0f0f0]" data-testid="front-all-in-one">
          <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center gap-10 sm:gap-12">
            <div className="flex-1">
              <div className="rounded-2xl p-4 sm:p-6" style={{ background: "#f0ede8" }}>
                <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-white/80">
                  ...
                  <div className="flex gap-3 sm:gap-4">
                    <div className="w-[120px] sm:w-[150px] shrink-0">
                      ...
                      {["AIS Dashboard", "Bureau Reports", "Disputes", "Capital Match", "Simulator", "Community", "Settings"].map((item, i) => (
                        <div key={item} className={`text-[12px] py-1.5 px-2 rounded ${i === 0 ? "bg-[#f5f5f5] font-semibold text-[#111] shadow-sm" : "text-[#888]"}`}>{item}</div>
                      ))}
                    </div>
                    <div className="flex-1 bg-[#fafafa] rounded-lg p-4 border border-[#f0f0f0]">
        ...
        <section className="py-[50px] sm:py-[80px] px-5 sm:px-6 bg-[#fafafa] border-t border-[#f0f0f0]" data-testid="front-funnels">
          <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center gap-10 sm:gap-12">
            <div className="flex-1">
              <div className="rounded-2xl p-4 sm:p-6" style={{ background: "#f0ede8" }}>
                <div className="bg-white rounded-xl p-5 shadow-lg border border-white/80 w-full max-w-[260px] mb-4">
                ...
                <div className="bg-white rounded-xl p-5 shadow-lg border border-white/80 w-full max-w-[240px] ml-0 sm:ml-10">
