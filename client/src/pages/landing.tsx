    ...
    <div className="relative min-h-screen text-[#e0e0f0] overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {showLogin && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => !isLoading && setShowLogin(false)}>
          <div className="w-full max-w-[400px] mx-4 bg-[#1a1a2e] border border-white/10 rounded-2xl shadow-2xl p-8 animate-in fade-in zoom-in-95 duration-200" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <BaalioLogo size="sm" className="text-white" />
              </div>
            ...
            <h2 className="text-[22px] font-semibold tracking-[-0.02em] text-white mb-1">Welcome back</h2>
            ...
            <form onSubmit={handleLoginModal}>
              <input
                ...
                className="w-full bg-white/10 border border-white/15 rounded-xl h-[48px] px-4 text-[14px] text-white placeholder:text-[#8a8ab0] outline-none focus:border-white/30 transition-colors mb-4"
                value={loginEmail}
      ...
      <section id="sec-hero" className="relative z-20 min-h-[90vh] flex flex-col items-center justify-center px-6 sm:px-12 md:px-20 lg:px-28 py-20 text-center">
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 90% 80% at 50% 50%, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.2) 50%, transparent 100%)' }} />
        ...
        <div className="relative max-w-[800px] mx-auto">
          ...
          <div className={`${contentBlockStyle} !p-5 sm:!p-6`}><div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={item.num} className="flex gap-4 items-start p-5 rounded-xl bg-white/5 border border-white/10">
        ...
        <div className="relative max-w-[800px] mx-auto">
          ...
          <div className={contentBlockStyle}><div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.label} className="p-4 sm:p-5 rounded-xl bg-white/5 border border-white/10">
        ...
        <div className="relative max-w-[800px] mx-auto">
          ...
          <div className={contentBlockStyle}><div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={item.step} className="flex flex-col items-center text-center p-6 rounded-xl bg-white/5 border border-white/10">
                ...
                <h3 className="text-[16px] sm:text-[18px] text-white font-medium mb-2">{item.title}</h3>
        ...
        <div className="relative max-w-[900px] mx-auto">
          ...
          <div className={contentBlockStyle}><div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.title} className="p-5 sm:p-6 rounded-xl bg-white/5 border border-white/10 group hover:bg-white/10 transition-colors">
                <span className="text-[20px] text-[#8a8aa5] mb-4 block">{item.icon}</span>
                <h3 className="text-[14px] sm:text-[15px] text-white font-medium mb-2">{item.title}</h3>
        ...
        <div className="relative max-w-[900px] mx-auto">
          ...
          <div className={`${contentBlockStyle} mb-14`}><div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={s.label} className="text-center p-5 rounded-xl bg-white/5 border border-white/10">
        ...
        <div className="relative max-w-[900px] mx-auto">
          ...
          <div className={contentBlockStyle}><div className="space-y-3">
            {[
              ...
              <div key={c.name} className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 p-5 rounded-xl bg-white/5 border border-white/10">
          ...
          <div className="mt-8 p-5 rounded-xl bg-white/5 border border-white/10">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-8">
              <span className="text-[15px] text-white font-medium">Total: 0–100 pts</span>
        ...
        <div className="relative max-w-[900px] mx-auto">
          ...
          <div className={contentBlockStyle}><div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-6 sm:p-8 rounded-xl bg-white/5 border border-white/10">
              ...
              <h3 className="text-[20px] sm:text-[24px] text-white font-light mb-4 tracking-[-0.02em]">Score 60+</h3>
          ...
          <div className={contentBlockStyle}><div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={t.tier} className={`p-6 rounded-xl bg-[#f8f8fc]/60 border ${t.color}`}>
                ...
                <h3 className="text-[18px] sm:text-[20px] text-white font-medium mt-2 mb-1">{t.name}</h3>
          ...
          <div className={contentBlockStyle}><div className="space-y-0">
            {faqItems.map((item, i) => (
              <div key={i} className="border-b border-[#404040]">
                ...
                >
                  <span className="text-[14px] sm:text-[15px] font-medium text-[#c0c0e0] group-hover:text-white transition-colors pr-4">{item.q}</span>
