  ...
  return (
    <div className="min-h-screen bg-[#0b0f17] text-white">
      <div className="mx-auto max-w-4xl px-5 py-14">
        <h1 className="text-3xl font-semibold">Creator funding placement</h1>
        <p className="mt-4 text-white/70">
          If you’re monetized and scaling output, offers, or sponsorships, we’ll tell you if you’re fundable and place you
          into the right funding options.
        </p>
