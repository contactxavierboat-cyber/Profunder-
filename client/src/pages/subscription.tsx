    ...
    <div className="min-h-[100dvh] bg-[#0D0D0D] text-white flex flex-col items-center justify-center p-3 sm:p-4 relative overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="z-10 w-full max-w-md space-y-6 sm:space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col items-center">
          <div className="w-[52px] h-[52px] sm:w-[64px] sm:h-[64px] rounded-[14px] sm:rounded-[16px] mb-5 sm:mb-8 bg-[#222222] border border-[#4A4A4A] flex items-center justify-center relative">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full border border-[#4A4A4A] bg-[#181818] mb-5 sm:mb-8">
            <span className="w-[7px] h-[7px] sm:w-[8px] sm:h-[8px] rounded-full bg-[#888] animate-pulse"></span>
            <span className="text-[11px] sm:text-[13px] font-semibold tracking-[0.12em] text-white uppercase">
          ...
          <p className="text-[#AAA] text-[13px] sm:text-[15px] text-center leading-[1.7] max-w-[380px] px-2">
            {isActive
        ...
        {!isActive && (
          <div className="bg-[#222222] border border-[#4A4A4A] rounded-xl p-3 sm:p-4 text-center">
            <p className="text-[12px] sm:text-sm text-[#CCC]" data-testid="text-subscription-inactive">Subscription inactive. Activate below to continue.</p>
          </div>
        )}

        <div className="bg-[#131313] border border-[#3A3A3A] rounded-2xl overflow-hidden">
          ...
          <div className="px-5 sm:px-8 pt-6 sm:pt-8 pb-2 text-center">
            <p className="text-[11px] sm:text-[13px] text-[#AAA] uppercase tracking-[0.1em] font-semibold mb-3 sm:mb-4">MentXr® Monthly</p>
            <div className="mb-1">
              <span className="text-[42px] sm:text-[52px] font-bold tracking-tight text-[#E0E0E0]" data-testid="text-price">$50</span>
              <span className="text-[#BBB] text-[13px] sm:text-[15px] ml-1">/month</span>
            </div>
            <p className="text-[#BBB] text-[12px] sm:text-[13px]">All-in-one fundability platform</p>
          </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              {features.map((feature, i) => (
                <div key={i} className="flex items-center gap-2.5 sm:gap-3">
                  <div className="w-4.5 h-4.5 sm:w-5 sm:h-5 rounded-full bg-[#222222] border border-[#4A4A4A] flex items-center justify-center shrink-0">
                    <Check className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-[#CCC]" />
                  </div>
          ...
          <div className="px-5 sm:px-8 pb-6 sm:pb-8">
            {isActive ? (
              <button
                ...
                className="w-full h-[44px] sm:h-[48px] rounded-full bg-[#222222] border border-[#4A4A4A] text-[#EEE] text-[13px] sm:text-[14px] font-bold hover:bg-[#222] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isProcessing ? (
        ...
        <div className="flex items-center justify-center gap-2 text-[11px] sm:text-[12px] text-[#BBB]">
