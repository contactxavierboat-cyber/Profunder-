  ...
  return (
    <div className="min-h-screen bg-[#0b0f17] text-white">
      <div className="mx-auto max-w-4xl px-5 py-14">
        <h1 className="text-3xl font-semibold">SMB funding</h1>
        <p className="mt-4 text-white/70">
          If you’re running a real operation, working capital usually unlocks growth. Prequalify first. If you qualify, we
          pursue funding options on your behalf.
        </p>
